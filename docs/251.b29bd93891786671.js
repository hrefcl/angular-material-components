      ...
      class Q {
        constructor() {
          (this.disabled = !1),
            ...
            (this.code1 = 'npm install --save @href/color-picker'),
            (this.code2 =
      ...
      (Q.ɵfac = function (o) {
        ...
        (Q.ɵcmp = t.Xpm({
          ...
          consts: [
            ...
            ['href', 'https://www.npmjs.com/package/@href/color-picker', 'target', '_blank'],
          ...
          template: function (o, e) {
            if (
              (1 & o &&
                ...
                t.qZA(),
                t.TgZ(6, 'h1'),
                t._uU(7, 'API reference for @href/color-picker'),
                t.qZA(),
                t.TgZ(8, 'h2'),
